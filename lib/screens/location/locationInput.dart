...
class _locationInputState extends State<LocationInput>{
  ...
  Future<void> _savePlace(double latitude, double longitude) async{
    final url = Uri.parse(
        "https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyDOaKsCi6IFVYNIm_1QvbkJ01JDW8cZ4OU");
        ...
        Row(
          ...
          children: [
            TextButton.icon(
                ...
                label: const Text("Get current locaion"),
